...
const Sidebar = ({ user, onLogout, currentView, setCurrentView }) => (
...
const Dashboard = ({ user, jobs, customers, pipelines, onCreateJob }) => (
...
const JobsView = ({ jobs, onCreateJob }) => {
...
const CustomersView = ({ customers, onCreateCustomer }) => (
  <div className="space-y-6">
    <div className="flex items-center justify-between">
      <div>
...
const PipelinesView = ({ pipelines, onCreatePipeline }) => (
  <div className="space-y-6">
    <div className="flex items-center justify-between">
      <div>
...
const App = () => {
  ...
  if (!isAuthenticated) {
    return <LoginPage onLogin={handleGitHubLogin} />;
  }
